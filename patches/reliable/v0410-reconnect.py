...
# A signaling event must only be acknowledged after the browser handles it.
# Previously the global signal cursor advanced first, so one transient
# setRemoteDescription/SDP failure permanently discarded the offer/answer and
# could leave audio or screen sharing asymmetric until both users rejoined.
once(
    'app/voice-room.tsx',
